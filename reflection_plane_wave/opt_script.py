...
measurement_data_file_path = "measurements/matlab_fullfield_sin1_scatter.csv"
...
result_path = "outputs/result_sin1_scat.h5"
...
plot_mesh_deformation_from_result(
    ...
    plot_file_name="outputs/mesh_deformation_sin1_scat.png",
    mesh_overlay_plot_file_name = "outputs/mesh_overlay_sin1_scat.png"
)

matlab_fullfield_csv_path = "measurements/matlab_fullfield_sin1_scatter.csv"
...
plot_projected_errors(results, "outputs/error_sin1_scat.png")
