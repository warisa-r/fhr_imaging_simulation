...
plot_mesh_deformation_from_result(
    ...
    plot_file_name="outputs/mesh_deformation_sin0.5_amp2.png",
    mesh_overlay_plot_file_name = "outputs/mesh_overlay_sin0.5_amp2.png"
)
...
plot_projected_errors(results, "outputs/error_sin0.5_amp2.png")
