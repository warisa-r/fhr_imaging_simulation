...
result_path = "outputs/result_sin0.5_amp2_noisy.h5"
...
plot_mesh_deformation_from_result(
    ...
    plot_file_name="outputs/mesh_deformation_sin0.5_amp2_noisy.png",
    mesh_overlay_plot_file_name = "outputs/mesh_overlay_sin0.5_amp2_noisy.png"
)
...
plot_projected_errors(results, "outputs/error_sin0.5_amp2_noisy.png")
