...
def run_optimization_and_return_residual():
    frequency = 5e9
...
if __name__ == "__main__":
    residual = run_optimization_and_return_residual()
    # Print residual as plain float so it can be parsed easily
    print(f"FINAL_RESIDUAL={residual}")