...
plt.plot(df_dolfin["x"], df_dolfin["u"], label="Dolfin", marker='o', markersize=2, linestyle='-', alpha=0.7)
plt.plot(df_matlab["x"], df_matlab["u"], label="Matlab", marker='x', markersize=2, linestyle='--', alpha=0.7)
plt.xlabel("x")
plt.ylabel("u")
...
plt.savefig("outputs/difference_dolfin_matlab_cos_freq1.5.png", dpi=300, bbox_inches='tight')
plt.show()